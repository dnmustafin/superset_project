...
<<<<<<< HEAD:superset-frontend/cypress-base/cypress/e2e/dashboard/_skip.tabs.test.ts
const LINE_CHART = { name: 'Growth Rate', viz: 'echarts_timeseries_line' };
=======
const LINE_CHART = { name: 'Growth Rate', viz: 'line' };
>>>>>>> my-branch:superset-frontend/cypress-base/cypress/e2e/dashboard/tabs.test.ts
